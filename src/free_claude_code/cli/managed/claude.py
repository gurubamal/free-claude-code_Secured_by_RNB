...
def build_managed_claude_command(
    *,
    ...
    # Remotely triggered requests use native restricted/read-only permissions and cannot
    # load inherited hooks, MCP servers, skills or unrestricted command tools.
    cmd += [
        "--restricted",
        "--permission-mode",
        "dontAsk",
